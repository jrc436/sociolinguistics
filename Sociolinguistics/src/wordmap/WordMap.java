...
public class WordMap extends IterMap<String, Combinable> implements Filterable<Entry<String, Combinable>> {
...
//	
	...
	@Override
	public void destroy(Entry<String, Combinable> el) {
		super.remove(el.getKey());
	}
